      ...
      <div className="content-main" >
        <div className="container">
          {isLoading ? ( // Check if data is loading
            ...
            <label>Email:</label>
            <input type="text" id="email" placeholder="Email" className="text-input" defaultValue={user.email.S} />
            <label>Address:</label>
            <input type="text" id="address" placeholder="Address" className="text-input" defaultValue={user.address.S} />
