...
const HttpTags = {
    ...
    fromJSON(object) {
        return {
            method: isSet$5(object.method) ? String(object.method) : "",
            protocol: isSet$5(object.protocol) ? String(object.protocol) : "",
            host: isSet$5(object.host) ? String(object.host) : "",
            path: isSet$5(object.path) ? String(object.path) : "",
            ...
            requestHeaderNames: Array.isArray(object === null || object === void 0 ? void 0 : object.requestHeaderNames)
                ...
                : [],
            statusCode: isSet$5(object.statusCode) ? Number(object.statusCode) : undefined,
            errorCode: isSet$5(object.errorCode) ? String(object.errorCode) : undefined,
        };
    },
    toJSON(message) {
        const obj = {};
...
const AwsTags = {
    ...
    fromJSON(object) {
        return {
            lambda: isSet$4(object.lambda) ? AwsLambdaTags.fromJSON(object.lambda) : undefined,
            sdk: isSet$4(object.sdk) ? AwsSdkTags.fromJSON(object.sdk) : undefined,
            accountId: isSet$4(object.accountId) ? String(object.accountId) : undefined,
            region: isSet$4(object.region) ? String(object.region) : undefined,
            requestId: isSet$4(object.requestId) ? String(object.requestId) : undefined,
            resourceName: isSet$4(object.resourceName) ? String(object.resourceName) : undefined,
            sequenceId: isSet$4(object.sequenceId) ? String(object.sequenceId) : undefined,
            logGroup: isSet$4(object.logGroup) ? String(object.logGroup) : undefined,
            logStream: isSet$4(object.logStream) ? String(object.logStream) : undefined,
        };
    },
    toJSON(message) {
        const obj = {};
...
const AwsApiGatewayTags = {
    ...
    fromJSON(object) {
        return {
            accountId: isSet$4(object.accountId) ? String(object.accountId) : "",
            apiId: isSet$4(object.apiId) ? String(object.apiId) : "",
            apiStage: isSet$4(object.apiStage) ? String(object.apiStage) : "",
            request: isSet$4(object.request) ? AwsApiGatewayTags_AwsApiGatewayRequestTags.fromJSON(object.request) : undefined,
        };
    },
    toJSON(message) {
        const obj = {};
...
const AwsApiGatewayTags_AwsApiGatewayRequestTags = {
    ...
    fromJSON(object) {
        return {
            id: isSet$4(object.id) ? String(object.id) : "",
            timeEpoch: isSet$4(object.timeEpoch) ? Long__default["default"].fromValue(object.timeEpoch) : Long__default["default"].UZERO,
...
const AwsLambdaTags = {
    ...
    fromJSON(object) {
        return {
            arch: isSet$4(object.arch) ? String(object.arch) : "",
            isColdstart: isSet$4(object.isColdstart) ? Boolean(object.isColdstart) : false,
            eventType: isSet$4(object.eventType) ? String(object.eventType) : undefined,
            eventSource: isSet$4(object.eventSource) ? String(object.eventSource) : undefined,
            logGroup: isSet$4(object.logGroup) ? String(object.logGroup) : undefined,
            logStreamName: isSet$4(object.logStreamName) ? String(object.logStreamName) : undefined,
            maxMemory: isSet$4(object.maxMemory) ? Number(object.maxMemory) : undefined,
            name: isSet$4(object.name) ? String(object.name) : "",
            requestId: isSet$4(object.requestId) ? String(object.requestId) : "",
            version: isSet$4(object.version) ? String(object.version) : "",
            accountId: isSet$4(object.accountId) ? String(object.accountId) : undefined,
            outcome: isSet$4(object.outcome) ? awsLambdaTags_OutcomeFromJSON(object.outcome) : 0,
            errorExceptionMessage: isSet$4(object.errorExceptionMessage) ? String(object.errorExceptionMessage) : undefined,
            errorExceptionStacktrace: isSet$4(object.errorExceptionStacktrace)
                ? String(object.errorExceptionStacktrace)
                : undefined,
            duration: isSet$4(object.duration) ? Number(object.duration) : undefined,
            requestBody: isSet$4(object.requestBody) ? String(object.requestBody) : undefined,
            responseBody: isSet$4(object.responseBody) ? String(object.responseBody) : undefined,
            logsStartTimeUnix: isSet$4(object.logsStartTimeUnix) ? Long__default["default"].fromValue(object.logsStartTimeUnix) : undefined,
            logsEndTimeUnix: isSet$4(object.logsEndTimeUnix) ? Long__default["default"].fromValue(object.logsEndTimeUnix) : undefined,
            responseMode: isSet$4(object.responseMode) ? awsLambdaTags_ResponseModeFromJSON(object.responseMode) : undefined,
            sqs: isSet$4(object.sqs) ? AwsSqsEventTags.fromJSON(object.sqs) : undefined,
            sns: isSet$4(object.sns) ? AwsSnsEventTags.fromJSON(object.sns) : undefined,
            http: isSet$4(object.http) ? HttpTags.fromJSON(object.http) : undefined,
            apiGateway: isSet$4(object.apiGateway) ? AwsApiGatewayTags.fromJSON(object.apiGateway) : undefined,
            httpRouter: isSet$4(object.httpRouter) ? HttpRouterTags.fromJSON(object.httpRouter) : undefined,
            initialization: isSet$4(object.initialization)
                ? AwsLambdaInitializationTags.fromJSON(object.initialization)
                : undefined,
            invocation: isSet$4(object.invocation) ? AwsLambdaInvocationTags.fromJSON(object.invocation) : undefined,
            runtime: isSet$4(object.runtime) ? AwsLambdaRuntimeTags.fromJSON(object.runtime) : undefined,
        };
    },
    toJSON(message) {
        const obj = {};
...
const HttpRouterTags = {
    ...
    fromJSON(object) {
        return { path: isSet$4(object.path) ? String(object.path) : "" };
    },
    toJSON(message) {
        const obj = {};
        message.path !== undefined && (obj.path = message.path);
...
const AwsSqsEventTags = {
    ...
    fromJSON(object) {
        return {
            queueName: isSet$4(object.queueName) ? String(object.queueName) : "",
...
const AwsSnsEventTags = {
    ...
    fromJSON(object) {
        return {
            topicName: isSet$4(object.topicName) ? String(object.topicName) : "",
            messageIds: Array.isArray(object === null || object === void 0 ? void 0 : object.messageIds) ? object.messageIds.map((e) => String(e)) : [],
        };
    },
    toJSON(message) {
...
const AwsLambdaRuntimeTags = {
    ...
    fromJSON(object) {
        return {
            identifier: isSet$4(object.identifier) ? String(object.identifier) : "",
            version: isSet$4(object.version) ? String(object.version) : "",
            arn: isSet$4(object.arn) ? String(object.arn) : "",
        };
    },
    toJSON(message) {
        const obj = {};
...
const AwsLambdaInitializationTags = {
    ...
    fromJSON(object) {
        return { initializationDuration: isSet$4(object.initializationDuration) ? Number(object.initializationDuration) : 0 };
    },
    toJSON(message) {
        const obj = {};
...
const AwsLambdaInvocationTags = {
    ...
    fromJSON(object) {
        return { invocationDuration: isSet$4(object.invocationDuration) ? Number(object.invocationDuration) : 0 };
    },
    toJSON(message) {
        const obj = {};
...
const AwsSdkTags = {
    ...
    fromJSON(object) {
        return {
            region: isSet$4(object.region) ? String(object.region) : undefined,
            signatureVersion: isSet$4(object.signatureVersion) ? String(object.signatureVersion) : undefined,
            service: isSet$4(object.service) ? String(object.service) : "",
            operation: isSet$4(object.operation) ? String(object.operation) : "",
            requestId: isSet$4(object.requestId) ? String(object.requestId) : undefined,
            error: isSet$4(object.error) ? String(object.error) : undefined,
            dynamodb: isSet$4(object.dynamodb) ? AwsSdkDynamodbTags.fromJSON(object.dynamodb) : undefined,
            sqs: isSet$4(object.sqs) ? AwsSdkSqsTags.fromJSON(object.sqs) : undefined,
            sns: isSet$4(object.sns) ? AwsSdkSnsTags.fromJSON(object.sns) : undefined,
        };
    },
    toJSON(message) {
        const obj = {};
...
const AwsSdkDynamodbTags = {
    ...
    fromJSON(object) {
        return {
            tableName: isSet$4(object.tableName) ? String(object.tableName) : undefined,
            projection: isSet$4(object.projection) ? String(object.projection) : undefined,
            scanForward: isSet$4(object.scanForward) ? Boolean(object.scanForward) : undefined,
            ...
            consistentRead: isSet$4(object.consistentRead) ? Boolean(object.consistentRead) : undefined,
            indexName: isSet$4(object.indexName) ? String(object.indexName) : undefined,
            limit: isSet$4(object.limit) ? Number(object.limit) : undefined,
            select: isSet$4(object.select) ? String(object.select) : undefined,
            segment: isSet$4(object.segment) ? Number(object.segment) : undefined,
            totalSegments: isSet$4(object.totalSegments) ? Long__default["default"].fromValue(object.totalSegments) : undefined,
            filter: isSet$4(object.filter) ? String(object.filter) : undefined,
            keyCondition: isSet$4(object.keyCondition) ? String(object.keyCondition) : undefined,
            exclusiveStartKey: isSet$4(object.exclusiveStartKey) ? String(object.exclusiveStartKey) : undefined,
            attributeValues: isSet$4(object.attributeValues) ? String(object.attributeValues) : undefined,
            count: isSet$4(object.count) ? Long__default["default"].fromValue(object.count) : undefined,
            scannedCount: isSet$4(object.scannedCount) ? Long__default["default"].fromValue(object.scannedCount) : undefined,
        };
    },
    toJSON(message) {
        const obj = {};
...
const AwsSdkSqsTags = {
    ...
    fromJSON(object) {
        return {
            queueName: isSet$4(object.queueName) ? String(object.queueName) : undefined,
            messageIds: Array.isArray(object === null || object === void 0 ? void 0 : object.messageIds) ? object.messageIds.map((e) => String(e)) : [],
        };
    },
    toJSON(message) {
...
const AwsSdkSnsTags = {
    ...
    fromJSON(object) {
        return {
            topicName: isSet$4(object.topicName) ? String(object.topicName) : undefined,
            messageIds: Array.isArray(object === null || object === void 0 ? void 0 : object.messageIds) ? object.messageIds.map((e) => String(e)) : [],
        };
    },
    toJSON(message) {
...
const ErrorTags = {
    ...
    fromJSON(object) {
        return {
            name: isSet$3(object.name) ? String(object.name) : "",
            message: isSet$3(object.message) ? String(object.message) : undefined,
            stacktrace: isSet$3(object.stacktrace) ? String(object.stacktrace) : undefined,
            type: isSet$3(object.type) ? errorTags_ErrorTypeFromJSON(object.type) : 0,
        };
    },
    toJSON(message) {
        const obj = {};
...
const NoticeTags = {
    ...
    fromJSON(object) {
        return {
            ...
            type: isSet$2(object.type) ? noticeTags_NoticeTypeFromJSON(object.type) : undefined,
        };
    },
    toJSON(message) {
        const obj = {};
...
const WarningTags = {
    ...
    fromJSON(object) {
        return {
            ...
            stacktrace: isSet$1(object.stacktrace) ? String(object.stacktrace) : undefined,
            type: isSet$1(object.type) ? warningTags_WarningTypeFromJSON(object.type) : undefined,
        };
    },
    toJSON(message) {
        const obj = {};
...
const Tags = {
    ...
    fromJSON(object) {
        return {
            aws: isSet(object.aws) ? AwsTags.fromJSON(object.aws) : undefined,
            http: isSet(object.http) ? HttpTags.fromJSON(object.http) : undefined,
            https: isSet(object.https) ? HttpTags.fromJSON(object.https) : undefined,
            sdk: isSet(object.sdk) ? SdkTags.fromJSON(object.sdk) : undefined,
            ...
            error: isSet(object.error) ? ErrorTags.fromJSON(object.error) : undefined,
            warning: isSet(object.warning) ? WarningTags.fromJSON(object.warning) : undefined,
            notice: isSet(object.notice) ? NoticeTags.fromJSON(object.notice) : undefined,
        };
    },
    toJSON(message) {
        const obj = {};
...
const SdkTags = {
    ...
    fromJSON(object) {
        return {
            ...
            runtime: isSet(object.runtime) ? String(object.runtime) : undefined,
        };
    },
    toJSON(message) {
        const obj = {};
