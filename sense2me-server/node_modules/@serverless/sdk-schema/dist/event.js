...
const Event = {
    ...
    fromJSON(object) {
        return {
            ...
            spanId: isSet(object.spanId) ? bytesFromBase64(object.spanId) : undefined,
            timestampUnixNano: isSet(object.timestampUnixNano) ? Long__default["default"].fromValue(object.timestampUnixNano) : Long__default["default"].UZERO,
            ...
            customFingerprint: isSet(object.customFingerprint) ? String(object.customFingerprint) : undefined,
    ...
    toJSON(message) {
        ...
        message.spanId !== undefined &&
            (obj.spanId = message.spanId !== undefined ? base64FromBytes(message.spanId) : undefined);
